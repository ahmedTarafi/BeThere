...
/**
 * Created by user2 on 04/08/2016.
 */
...
public abstract class GPSTracker extends Service implements LocationListener {
    ...
    private static final long MIN_TIME_BW_UPDATES = 1000 * 10 * 1; // 10 seconde
   ...
   /* public double getSpeed(){
    ...
    public void showSettingsAlert(){
        ...
        alertDialog.setMessage("Enable location discovery!. Do you want to go to settings menu?");
